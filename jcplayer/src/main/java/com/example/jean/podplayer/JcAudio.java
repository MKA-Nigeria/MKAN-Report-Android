...
public class JcAudio implements Serializable {
    ...
    public JcAudio(String title, String path, Origin origin, String artURL, String subtitle) {
        // It looks bad
        //int randomNumber = path.length() + title.length();
    ...
    public static JcAudio createFromURL(String title, String url, String artURL, String subtitle) {
        return new JcAudio(title, url, Origin.URL, artURL, subtitle);
    }
