...
import com.aliumujib.jean.podplayer.JcPlayerExceptions.AudioAssetsInvalidException;
import com.aliumujib.jean.podplayer.JcPlayerExceptions.AudioFilePathInvalidException;
import com.aliumujib.jean.podplayer.JcPlayerExceptions.AudioRawInvalidException;
import com.aliumujib.jean.podplayer.JcPlayerExceptions.AudioUrlInvalidException;
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (jcPlayerServiceListeners != null) {
            for (JcPlayerView.JcPlayerViewServiceListener jcPlayerServiceListener : jcPlayerServiceListeners) {
                ...
                jcPlayerServiceListener.onPreparedAudio(currentJcAudio, mediaPlayer.getDuration());
            }
        }

        if (notificationListener != null) {
            notificationListener.updateTitle(currentJcAudio.getTitle());
            notificationListener.onPreparedAudio(currentJcAudio, mediaPlayer.getDuration());
        }
